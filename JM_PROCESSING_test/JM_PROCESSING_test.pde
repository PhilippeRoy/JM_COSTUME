...
//%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 // video = new Capture(this, w, h);    //For LIVE
  ...
  video = new Movie(this, "JPLS3.mov");                //For VIDEO   // Play movie
...
//Change how fast the colors change from no light -> white -> red -> no light
  ...
  group1Trigger = 0;      //Group 1 Starts at (0 - 100)
  group2Trigger = 10;     //Group 2 Starts at (0 - 100)
  group3Trigger = 20;      //Group 3 Starts at (0 - 100)
...
void sendMessage() {     
  String myPackage = ( "*" + checksum+"," + G5value + "," + RedG5value + "," + G6value + "," + RedG6value  + ","  + G3value + "," + RedG3value + "," + G4value + "," + RedG4value  +  ",#");
